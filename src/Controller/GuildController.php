...
class GuildController extends AbstractController
{
   ...
   */
  public function raids(string $slug, Request $request): Response
  {
    $entityManager = $this->getDoctrine()->getManager();
    $guild = $entityManager->getRepository(Guild::class)->findOneBySlug($slug);
   ...
   * @IsGranted("ROLE_USER")
   */
  public function raids_join(string $slug, Request $request): Response
  {
    $entityManager = $this->getDoctrine()->getManager();
    $guild = $entityManager->getRepository(Guild::class)->findOneBySlug($slug);
   ...
   * @IsGranted("ROLE_USER")
   */
  public function raids_leave(string $slug, Request $request): Response
  {
    $entityManager = $this->getDoctrine()->getManager();
    $guild = $entityManager->getRepository(Guild::class)->findOneBySlug($slug);
