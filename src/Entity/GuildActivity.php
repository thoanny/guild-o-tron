...
/**
 * @ORM\Entity(repositoryClass="App\Repository\GuildActivityRepository")
 */
class GuildActivity
{
    /**
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Guild", mappedBy="guild_activities")
     */
    private $guilds;
    ...
    public function removeGuild(Guild $guild): self
    {
        if ($this->guilds->contains($guild)) {
            ...
            $guild->removeGuildActivity($this);
        }
